...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='faqModel',
            fields=[
                ('index', models.IntegerField(help_text='Introduzca un índice.', primary_key=True, serialize=False, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5000)], verbose_name='Índice')),
                ('question', models.CharField(help_text='Introduzca una pregunta.', max_length=300, verbose_name='Pregunta')),
                ('answer', models.TextField(help_text='Introduzca una respuesta.', max_length=2000, verbose_name='Respuesta')),
            ],
            options={
